...
const { GITHUB_SHA, GITHUB_REPOSITORY, GIT_COMMITTER_NAME, GIT_COMMITTER_EMAIL, GIT_AUTHOR_NAME, GIT_AUTHOR_EMAIL } =
  process.env;
...
!GIT_COMMITTER_NAME && (process.env.GIT_COMMITTER_NAME = "golivwell automator[bot]");
!GIT_COMMITTER_EMAIL &&
  (process.env.GIT_COMMITTER_EMAIL = "159287579+medijobs-automator[bot]@users.noreply.github.com");
